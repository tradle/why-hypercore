...
Any Database Server can be accessed remotely and many can serve huge databases. But they need operational management and have associated human resources costs. Such costs are detrimental for example to a new popularity with developers class of Serverless applications.
