...
Hypercore is so much more. It is a foundation to create apps, that is storage, content distribution, compute, messaging, networking, analytics, AI and more.

We believe the answer exists elsewhere. We call this concept a Personal Cloud, an always-available durable peer, companion to my other less capable personal devices, a place where Hypercore apps can run. We believe Personal Cloud will make Hypercore shine.
